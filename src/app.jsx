...
export const App = component$(() => {
  ...
  return (
    <div>
      ...
      <nav class={isOpen.value ? "nav-menu" : "hidden"} id="nav-menu">
      ...
      <main>
        ...
        <div class="shadow-cont" id="about">
          ...
          <p>
            Faaz Tech Concert 2025 brings together leading minds in programming,
            tech and innovation
          </p>
        </div>
        ...
        <div class="shadow-cont" id="schedule">
          ...
          <div class="countdown-cont">
            <img
              src="/assets/images/countdown-clock.jpg"
              alt="clock countdown"
              class="countdown-img"
            />
            <div class="timer-cont">
              ...
              <div class="countdown-timer" id="countdown-timer">
                <p>Date: <span>{date.value}</span></p>
                <p>Time: <span>{time.value}</span></p>
              </div>
            </div>
          </div>
        </div>
